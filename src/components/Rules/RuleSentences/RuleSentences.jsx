    ...
    return (
        <StyledRuleWrapper>
            ...
            <StyledRuleDescription>
                ...
                мові ми можемо обійтися без суб'єкта <i>("На дворі дощить")</i>,
                але в норвезькій мові так робити не можна, тому часто
                використовується підмет <span>"Det"</span> як суб'єкт.{" "}
                <StyledRuleExample>
                    {" "}
                ...
                <span>"бути"</span> в нашій мові, в норвезькій мові воно
                обов'язкове.{" "}
                <StyledRuleExample>
